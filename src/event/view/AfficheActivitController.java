 ...
 * @author Sarra
 */
public class AfficheActivitController implements Initializable {
    ...
    private void addReserv3(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/event/view/Reservation.fxml"));
    ...
    private void addReserv2(ActionEvent event) throws IOException {
              Parent root = FXMLLoader.load(getClass().getResource("/event/view/Reservation.fxml"));
    Stage window = (Stage) add2.getScene().getWindow();
    window.setScene(new Scene(root));
    window.setTitle("Modifier Activite");
    }
